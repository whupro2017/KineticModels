...
const api_handprint = require('./routes/api/hand');
...
app.use('/api/hand', api_handprint);
...
// 手印模块
const handprint_list = require('./routes/web/hand/list');
const handprint_detail = require('./routes/web/hand/detail');
// tool 模块
...
// handprint
app.use('/web/hand/list', handprint_list);
app.use('/web/hand/detail', handprint_detail);
// tool
