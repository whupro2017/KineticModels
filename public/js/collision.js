...
function pz_start() {
    ...
    viewer.dataSources.add(dataSourcePromise).then(function (dataSource) {
        ...
        mix_particleSystem = scene.primitives.add(new Cesium.ParticleSystem({
            show: false,
            image: './imgs/fire.png',
        ...
        mix_listener=function () {
            ...
            if (clock.currentTime.dayNumber >= 2458319 && clock.currentTime.secondsOfDay >= 11950) {
                mix_particleSystem.show = true;
            }else{
                mix_particleSystem.show = false;
            }
        ...
        scene.postRender.addEventListener(mix_listener);
